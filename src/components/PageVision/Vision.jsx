            ...
            <div className="centered-container">
                ...
                <section className='watch-youtube-video-container' aria-label="Watch Vision Pro Video">
                    <div className='h1-box'>
                        ...
                        <h1>So you can work, watch, relive memories, and connect in ways never before possible.</h1>
                    ...
                    <div className="vision-closer-image-box">
                ...
                <section className='functionality-section-articles'>
                    <article className="entertainment-container category-container" aria-label="Entertainment">
                        ...
                        <h1 className='section-title'>The ultimate theater. Wherever you are.</h1>
                        <video className="category-vision-video" muted autoPlay loop role="img" controls>
                            <source src={entertainmentVideo} alt="Entertainment Video" type='video/mp4' />
                        </video>
                        <div className="entertainment-box box">
                            <h3 className='box-subtitle'>A new dimension for entertainment.</h3>
                    ...
                    <article className="productivity-container category-container" aria-label="Productivity">
                        ...
                        <h1 className='section-title'>A workspace with infinite space.</h1>
                        <video className="category-vision-video" muted autoPlay loop role="img" controls>
                            <source src={productivityVideo} alt="Productivity Video" type='video/mp4' />
                        </video>
                        <div className="productivity-box box">
                            <h3 className="box-subtitle">Discover new ways to work.</h3>
                    ...
                    <article className="photos-and-videos-container category-container" aria-label="Photos and Videos">
                        ...
                        <h1 className='section-title'>Be in the moment. All over again.</h1>
                        <video className="category-vision-video" muted autoPlay loop role="img" controls>
                            <source src={photosAndVideosVideo} alt="Photos and Videos Video" type='video/mp4' />
                        </video>
                        <div className="photos-and-videos-box box">
                            <h3 className="box-subtitle">Your memories come alive.</h3>
                    ...
                    <article className='connection category-container' aria-label="Connection">
                        ...
                        <h1 className='section-title'>Share quality time. And space.</h1>
                        <video className="category-vision-video" muted autoPlay loop role="img" controls>
                            <source src={connectionVideo} alt="Connection Video" type='video/mp4' />
                        </video>
                        <div className="connection-box box">
                            <h3 className='box-subtitle'>A more engaging way to get together.</h3>
                    ...
                    <article className='apps category-container' aria-label="Apps">
                        ...
                        <h1 className='section-title'>Do what you love. Reimagine how you do it.</h1>
                        <video className="category-vision-video" muted autoPlay loop role="img" controls>
                            <source src={appsVideo} alt="Apps Video" type='video/mp4' />
                        </video>
                        <div className="apps-box box">
                            <h3 className='box-subtitle'>A world of apps. A world of discovery.</h3>
                    ...
                    <article className='vision-OS category-container' aria-label="VisionOS">
                        ...
                        <h1 className='section-title'>An operating system designed for spatial.</h1>
                        <video className="category-vision-video" muted autoPlay loop role="img" controls>
                            <source src={visionOSVideo} alt="visionOS Video" type='video/mp4' />
                        </video>
                        <div className="vision-os-box box">
                            <h3 className='box-subtitle'>Navigate spatial experiences. Naturally.</h3>
                ...
                <section className="design category-container" aria-label="Design">
                    ...
                    <div className="descriptions-box">
                        <div className='description-item'>
                            <p className='description-p'>
                                <span className='description-p-span'>Front.</span> A singular piece of three-dimensionally formed laminated glass flows into an aluminum alloy frame that curves to wrap around your face.
                            </p>
                        </div>
                        <div className='description-item'>
                            <p className='description-p'>
                                <span className='description-p-span'>Light Seal.</span> The Light Seal gently flexes to conform to your face, delivering a precise fit while blocking out stray light.
                            </p>
                        </div>
                        <div className='description-item'>
                            <p className='description-p'>
                                <span className='description-p-span'>Head bands.</span> The Solo Knit Band provides cushioning, breathability, and stretch, and a Fit Dial lets you adjust Apple Vision Pro precisely to your head. The Dual Loop Band offers an additional option for a personalized fit.
                            </p>
                        </div>
                        <div className='description-item'>
                            <p className='description-p'>
                                <span className='description-p-span'>Power.</span> The external battery supports up to 2 hours of general use and up to 2.5 hours of video playback.
                            </p>
                        </div>
                        <div className='description-item'>
                            <p className='description-p'>
                                <span className='description-p-span'>Sound.</span> Speakers positioned close to your ears deliver rich Spatial Audio while keeping you aware of your surroundings.
                            </p>
                        </div>
                    </div>
                ...
                <div className="front-image-container">
                    <figure>
                        ...
                        <figcaption className='front-image-figcaption'> 
                            ...
                            An outward display reveals your eyes while wearing Apple Vision Pro, letting 
                ...
                <section className='technology-section'>
                    <div className="technology-container">
                        ...
                        <h1 className='tech-h1'>Innovation you can see, hear, and feel.</h1>
                    ...
                    <div className="spatial-container">
                        ...
                        <div className='spatial-text-box'>
                            <h2 className='spatial-h2'>Our most advanced Spatial Audio system ever.</h2>
                    ...
                    <div className="angle-container">
                        <div className='front-image-container'>
                            <img src={insideImage} alt="Vision Pro Inside Image" className='inside-image'/>
                        </div>
